...
The application is running on (https://danielsammarco.shinyapps.io/Course-Project-Shiny-Application-and-Reproducible-Pitch/)

ui.R, and Server.R Code in my github repository (https://github.com/Sammarquinho/Course-Project-Shiny-Application-and-Reproducible-Pitch.git)
